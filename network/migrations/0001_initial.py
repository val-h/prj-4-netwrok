    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pfp', models.ImageField(blank=True, default='media/open_SUS.png', upload_to='media')),
                ('followers', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='following', to=settings.AUTH_USER_MODEL)),
